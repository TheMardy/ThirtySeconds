<script>
    import {getCurrentPlayer, roomPointsToWin, getOrderedTeams, endGame, roomRound } from '../../stores/multiDeviceStores.js'
...
<div class="" in:fly>
    ...
    <div class="vertical-center">
        <div class="container-fluid">
            {#if getOrderedTeams()[0].points >= $roomPointsToWin}
                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-body text-center c-purple">
                            <h5 class="d-inline">Ronde {$roomRound + 1} </h5>
